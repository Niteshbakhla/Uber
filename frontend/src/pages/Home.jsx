            ...
            return (
                        ...
                        >
                                    ...
                                    <div className="bg-black w-full h-[200px] flex flex-col items-center p-6">
                                                ...
                                                {/* Button */}
                                                <Link to="/login" className="bg-white w-full text-center  text-black px-16 font-bold py-3 rounded   text-3xl lg:hover:bg-gray-800 active:bg-orange-400 active:text-white transition">
                                                            Continue
                                                </Link>
                                    </div>
                        </div>
